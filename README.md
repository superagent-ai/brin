...
|-------|------|-------------|
| `origin` | string | source type: `npm`, `pypi`, `crate`, `domain`, `page`, `repo`, `skill`, `mcp`, `contributor`, `email` |
...
| `email` | email addresses | spoofing, phishing domains, reputation signals |
